function semi_fnn_fg_func_c(data_name, kfolds, n_rules, n_mixup, labeled_num, mu, gamma, eta, alpha, beta)
    log_path = './log/';
    ...
    [result_train_mean_g, result_train_std_g, result_test_mean_g, result_test_std_g, time_g]=...
        semi_fnn_fg_func_c_g(data_name, kfolds, n_rules, labeled_num, mu,beta);
    ...
    [result_train_mean_lg, result_train_std_lg, result_test_mean_lg, result_test_std_lg, time_lg]=...
        semi_fnn_fg_func_c_lg(data_name, kfolds, n_rules, labeled_num, mu, beta);
    
    % ==============all data involved (ug)============%
    
    [result_train_mean_ug, result_train_std_ug, result_test_mean_ug, result_test_std_ug, time_ug]=...
        semi_fnn_fg_func_c_ug(data_name, kfolds, n_rules, labeled_num, mu, eta, beta);
    
    
    % ==============semi-fnn (um)============%
    
    [result_train_mean_um, result_train_std_um, result_test_mean_um, result_test_std_um, time_um]=...
        semi_fnn_fg_func_c_um(data_name, kfolds, n_rules, n_mixup, labeled_num, mu, gamma, alpha, beta);
